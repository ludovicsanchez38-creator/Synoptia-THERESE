...
- [ ] **DA brutaliste partielle** : Button.tsx + home + badges PARTOUT (lot 2 badges fait le 11/06, commits a88e127/0031b67 : tous les badges d'etat en tags carres rounded-[6px], restent ronds compteur cloche/toggles/radios/avatars). Cartes de panneaux, inputs, modales, bulles de message, SideToggle gardent l'ancien style doux - lot 3 eventuel.
