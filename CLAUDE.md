...
**THERESE v2** - Assistant IA desktop souverain pour solopreneurs et TPE français.
Memoire persistante, UX premium dark mode, données 100% locales.
...
- **Accents obligatoires** : ecrire en francais correct
- **PPTX/DOCX** : Ne PAS generer de preview LibreOffice
- **Fenetres Tauri** : Ne PAS utiliser `onCloseRequested` (bloque la croix macOS), utiliser `once('tauri://destroyed')`
