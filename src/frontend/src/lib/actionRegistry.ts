...
export const APP_ACTIONS: AppAction[] = [
  ...
  { id: 'memory.search', label: 'Rechercher dans les Contacts', description: 'Chercher dans les contacts', group: 'Mémoire', shortcut: '⇧F', keywords: ['recherche', 'find'], run: () => { nav().setView('memory'); nav().requestMemorySearchFocus(); } },
  ...
  { id: 'invoices.open', label: 'Ouvrir les Devis et factures', description: 'Factures et devis', group: 'Navigation', shortcut: 'I', keywords: ['devis'], run: () => nav().setView('invoices') },
  ...
  { id: 'files.open', label: 'Ouvrir les Fichiers', description: 'Parcourir et indexer des fichiers locaux', group: 'Navigation', keywords: ['fichiers', 'indexation', 'documents'], run: () => nav().setView('files') },
  { id: 'documents.open', label: 'Ouvrir les Documents', description: 'Rédiger un document : propositions, dossiers, rapports', group: 'Navigation', keywords: ['documents', 'atelier', 'trame', 'sections', 'rédaction'], run: () => nav().setView('documents') },
  ...
  { id: 'board.open', label: 'Décision', description: 'Convoquer le board de conseillers IA', group: 'Navigation', shortcut: 'D', run: () => panel().toggleBoardPanel() },
