...
export {
  ...
  apercuImportContacts,
  importerContactsTableur,
  type ApercuImportContacts,
  type ResultatImportContacts,
  type LigneDImport,
  type VCFDownloadResult,
  type Contact,
  type Project,
  type EnsembleDuProjet,
  type FamilleListee,
  type ConversationDuProjet,
  type DocumentDuProjet,
  type TacheDuProjet,
  type ContactDuProjet,
  type MemoryScope,
  type ScopeFilter,
  type DeleteResponse,
} from './memory';
...
// Documents - Atelier documentaire (CRUD, trame, rédaction SSE, export)
export {
  createDocument,
  listDocuments,
  getDocument,
  ...
  type SectionsReorderItem,
  type PisteCreateRequest,
  type DraftRequest,
