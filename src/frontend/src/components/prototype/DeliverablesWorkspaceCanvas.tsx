        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
          ...
          {view?.project && <>
            <section className="mt-4 rounded-[13px] border border-border bg-surface p-4">
              ...
              {detail?.deliverables.status === 'ready' && <div className="mt-3 h-2 overflow-hidden rounded-full bg-[#E9EEF5]"><div className="h-full rounded-full bg-[#0F8FB3] transition-[width]" style={{ width: `${view.deliverables.length ? Math.round((view.validated / view.deliverables.length) * 100) : 0}%` }} /></div>}
            </section>
