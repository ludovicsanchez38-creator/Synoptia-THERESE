    ...
    <div className="space-y-4" data-testid="meeting-new-event-form">
      <section className="rounded-md border border-border bg-surface p-4">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <label className="text-sm font-semibold text-text">Lieu ou lien<input value={location} onChange={(event) => { setLocation(event.target.value); setConfirming(false); }} className="mt-1.5 w-full rounded-md border border-border px-3 py-2 text-sm font-normal outline-none focus:border-accent" /></label>
