        ...
        <header data-dialog-allow className="flex min-h-14 shrink-0 items-center border-b border-border bg-surface px-3 sm:px-4">
          <div className="flex flex-1 items-center gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="rounded-full border border-border bg-surface-2 px-2 py-0.5 text-xs font-semibold uppercase tracking-wide text-text-muted">Interface unifiée</span>
            </div>
          </div>
