...
export const TEXTES_ONBOARDING = {
  ...
  risques: [
    ...
    },
    {
      ...
      description:
        'L’audio est envoyé à Groq pour transcription, sauf si la dictée locale (Whisper) est choisie dans Paramètres > Confidentialité. Ne dicte pas d’informations confidentielles.',
      severity: 'medium',
    },
