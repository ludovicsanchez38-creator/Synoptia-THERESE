...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  {
    id: 'ouvrir-crm',
    name: 'ouvrir pipeline',
    description: 'Ouvrir le Pipeline (action locale, sans IA)',
    icon: <UserPlus className="w-4 h-4" />,
    prefix: '{action: ouvrir pipeline}',
    actionId: 'crm.open',
  },
  {
    id: 'ouvrir-memoire',
    name: 'ouvrir contacts',
    description: 'Ouvrir les Contacts (action locale, sans IA)',
    icon: <Search className="w-4 h-4" />,
    prefix: '{action: ouvrir contacts}',
    actionId: 'memory.open',
  },
  {
    id: 'ouvrir-calendrier',
    name: 'ouvrir agenda',
    description: "Ouvrir l'Agenda (action locale, sans IA)",
    icon: <Calendar className="w-4 h-4" />,
    prefix: '{action: ouvrir agenda}',
  ...
  },
  {
    ...
    name: 'ouvrir devis et factures',
    description: 'Ouvrir les Devis et factures (action locale, sans IA)',
    icon: <FileSpreadsheet className="w-4 h-4" />,
    prefix: '{action: ouvrir devis et factures}',
