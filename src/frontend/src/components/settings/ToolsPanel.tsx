              ...
              <div className="flex items-center justify-between p-3">
                ...
                >
                  <div className={`w-2 h-2 rounded-full ${
                    server.status === 'running' ? 'bg-success-fill animate-pulse' :
                    server.status === 'starting' ? 'bg-warning-fill animate-pulse' :
                    server.status === 'error' ? 'bg-error-fill' : 'bg-border'
                  }`} />
            ...
            >
              ...
              <div className="flex items-center justify-end gap-3 mt-6">
                ...
                <Button
                  ...
                  className="bg-error-fill text-error-ink hover:opacity-90"
                >
                  Supprimer
                </Button>
              </div>
