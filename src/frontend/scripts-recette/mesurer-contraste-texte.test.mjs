...
try {
  ...
  for (const [name, css, reason] of [
    ...
    ['première ligne : texte noir sur noir', '#case::first-line { color: black; }', 'pseudo-texte-style'],
    ['première lettre : texte noir sur noir', '#case::first-letter { color: black; }', 'pseudo-texte-style'],
    ['première ligne : fond blanc sous texte blanc', '#case::first-line { background-color: white; }', 'pseudo-texte-style'],
    ['première lettre : fond blanc sous texte blanc', '#case::first-letter { background-color: white; }', 'pseudo-texte-style'],
