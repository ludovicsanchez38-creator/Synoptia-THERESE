...
ERROR_MESSAGES = {
    ErrorCode.API_UNREACHABLE: "Le service {service} est temporairement indisponible. Vérifie ta connexion internet.",
    ErrorCode.API_TIMEOUT: "Le service {service} met trop de temps à répondre. Nouvelle tentative en cours...",
    ErrorCode.API_RATE_LIMITED: "Trop de requêtes envoyées. Attends quelques instants avant de réessayer.",
    ErrorCode.API_AUTH_FAILED: "Clé API {provider} invalide ou expirée. Vérifie tes paramètres.",
    ErrorCode.API_SERVER_ERROR: "Erreur serveur chez {provider}. L'équipe technique est probablement au courant.",
    ErrorCode.LLM_PROVIDER_UNAVAILABLE: "Le modèle {model} n'est pas disponible. Essaie un autre provider.",
    ErrorCode.LLM_CONTEXT_TOO_LONG: "Le message est trop long ({tokens} tokens). Raccourcis-le ou commence une nouvelle conversation.",
    ErrorCode.LLM_GENERATION_FAILED: "La génération de réponse a échoué. Réessaie dans quelques instants.",
    ErrorCode.DB_CONNECTION_FAILED: "Impossible de se connecter à la base de données locale.",
    ErrorCode.DB_QUERY_FAILED: "Erreur lors de l'accès aux données. Redémarre l'application si le problème persiste.",
    ...
    ErrorCode.MCP_SERVER_FAILED: "Le serveur MCP {server} n'a pas pu démarrer. Vérifie la configuration.",
