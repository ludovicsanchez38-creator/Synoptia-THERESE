# Protocole : campagne « chaque écran, chaque persona », THÉRÈSE 0.69.0, main 0f7418a1 (cycle 6)

> Campagne du cycle 6, 10/09/2026, même méthode que le cycle 3. Demande de Ludo, 05/09/2026 : « ce qui permet le plus de voir les bugs, c'est les
...
- Backend jetable : `http://127.0.0.1:17393`, `THERESE_DATA_DIR=/tmp/therese-demo-c6/data`
  (base VIERGE au départ pour Sophie, qui fait la mise en route ; ensuite les données que
  les personas y déposent eux-mêmes, dans l'ordre Sophie, Nadia, Jean). Jeton dans `/tmp/therese-demo-c6/data/.session_token`,
...
- Instrument : Playwright (serveur MCP `plugin_playwright_playwright`), document toujours
  ...
  à 1024×768 et en thème sombre. Le frontend vient de `main` (0f7418a1)
  , avec les onze propositions du cycle 5 et les correctifs de la 0.69.0.
...
1. capture plein écran : `browser_take_screenshot` avec `filename` =
   `docs/campagnes/2026-09-10-personas-c6/captures/<persona>/<NN>-<capacite>-<etape>.png`
...
Fichier : `docs/campagnes/2026-09-10-personas-c6/rapports/<persona>.md`, en français.
