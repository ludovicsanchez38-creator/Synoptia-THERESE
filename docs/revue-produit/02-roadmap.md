...
- [x] **Phase 1 — refonte navigation** (content-swap par vues) : layout validé (zone principale, Linear/Notion), spec (`phase1-navigation-spec.md`), `navigationStore`. **L1-L9 FAITS** : L1 (CRM en vue, vérifié navigateur), **L2-L5 (Email/Agenda/Tâches/Factures en vues, `b365131`)**, **L9 (machinerie fenêtres-panels supprimée, `c4ed628`)**, **L6/L7/L8 ci-dessous**. Reste vérifs visuelles navigateur (L6 pastille, L7, L8) + Lot 10 (post-Phase 1). Détail :
