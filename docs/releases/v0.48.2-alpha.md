...
- [x] **Devise tranchée par Ludo le 26/08/2026 : on reste en dollars**, pas de conversion ni d'API de taux. Le montant affiché est celui que le fournisseur facture ; une conversion aurait produit un chiffre d'apparence exacte mais toujours décalé du relevé bancaire (taux du jour du débit + frais de change).
