...
class TestBUG041_LayoutShiftStreaming:
    ...
    def test_layout_disabled_during_streaming(self):
        ...
        # S'assurer qu'il n'y a pas de layout=true non conditionnel
    ...
    def test_contain_always_includes_layout(self):
        ...
        # Vérifier qu'il n'y a plus de contain sans 'layout' pendant le streaming
    ...
    def test_min_height_fixed_during_streaming(self):
        ...
        content = self.MSG_BUBBLE.read_text(encoding="utf-8")
        # 56px = py-3 (24px) + 1 ligne leading-relaxed (~32px) : valeur fixe, pas recalculée
        ...
        # S'assurer que le calcul dynamique a disparu
